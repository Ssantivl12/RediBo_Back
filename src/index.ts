...
// Nueva ruta para el filtrado por distancia (funcionalidad GPS)
import filtroRouter from './routes/filtroGPSRoutes';
...
// NUEVA: Rutas de filtrado por distancia (vehículos cercanos)
app.use('/filtro2', filtroRouter);
